...
namespace mycamera
{
    ...
    public:
        ...
        glm::vec3 GetNextPos(float distance)
        {
            distance += 0.6;
            glm::vec3 next_pos;
            glm::vec3 dir = glm::normalize(glm::vec3(forward.x, 0, forward.z));
            next_pos = position + dir * distance;
        ...
        void MoveForwardWithAngle(float distance, float angle) {
            glm::mat2 rotateDirection = glm::transpose(glm::mat2(cos(angle), -sin(angle), sin(angle), cos(angle)));
            glm::vec2 dir2 = rotateDirection * glm::vec2(forward.x, forward.z);
            glm::vec3 dir = glm::normalize(glm::vec3(dir2.x, 0, dir2.y));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            right = glm::normalize(rotation * glm::vec4(right, 0.0));
