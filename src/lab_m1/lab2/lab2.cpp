...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 0.1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0.1, 0.2, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0.2, 0.3, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.5, 0.4, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0.1, 0.5, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0.4, 0.6, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0.7, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
    ...
    // by definition!
        ...
        vector<VertexFormat> vertices2
        {
            ...
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 0.1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0.7, 0.2, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0.4, 0.6, 1), glm::vec3(0.2, 0.8, 0.6)),
        ...
        meshes["tethr"] = new Mesh("generated tethr");
        meshes["tethr"]->InitFromData(vertices2, indices2);
        CreateMesh("tethr", vertices2, indices2);
     ...
     vector<VertexFormat> vertices3
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 0.1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0.7, 0.2, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0.4, 0.6, 1), glm::vec3(0.2, 0.8, 0.6)),
        ...
        meshes["extra_s"] = new Mesh("generated extra square");
        meshes["extra_s"]->InitFromData(vertices3, indices3);
        CreateMesh("extra_s", vertices3, indices3);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tethr"], shaders["VertexColor"], glm::vec3(-3.5f, 0.5f, 0), glm::vec3(0.25f));


    // TODO(student): Draw the square
    RenderMesh(meshes["extra_s"], shaders["VertexColor"], glm::vec3(-4.5f, 0.5f, 0), glm::vec3(0.25f));
